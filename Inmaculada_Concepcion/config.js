...
window.MUSEO_CONFIG = {
  ...
  // color): Carnación->Rostro, Verde->Manto(verdigris), Rojo1 y Rojo2->Manto
  // (bermellón, mismo texto, cada uno con su propia imagen), Azul->Nube,
  // Amarillo->Blonda, Morado->Querubín, Blanco->Huerto.
  hotspots: [
    ...
    { x: 0.757, y: 0.460, size: 0.051, color: "#c1431f", img: "assets/micro-rojo2.webp", titulo: "Manto", pigmento: "Bermellón", formula: "HgS", nota: "Detalle del interior del manto de la Virgen con pigmento bermellón o cinabrio que es un sulfuro de mercurio." },
